...
public class PathSumII {
    ...
    // 遍历的路径
    public static ArrayList curPath = new ArrayList();
    // 匹配的路径 
    public static List<List<Integer>> successPath = new ArrayList();
...
//        al.add(1);
        ...
        List<List<Integer>> aaa = (new PathSumII()).pathSum(tree, 0);
...
//        }
    ...
    public static void outputTree(TreeNode tree) {
        // 树的深度
        int level = (new PathSumII()).maxDepth(tree);
